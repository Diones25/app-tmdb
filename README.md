...
| Tela | Descrição |
|------|-----------|
| <img src="screenshots/home.png" alt="Home" width="300" /> | **Home / Dashboard** — Tela principal com abas para navegar entre filmes populares, lançamentos, séries, canais ao vivo e pessoas famosas. |
| <img src="screenshots/detalhes-filme.png" alt="Detalhes do Filme" width="300" /> | **Detalhes do Filme** — Página completa com pôster, backdrop, trailer, elenco, avaliações, mídia, recomendações e players de streaming. |
| <img src="screenshots/detalhes-serie.png" alt="Detalhes da Série" width="300" /> | **Detalhes da Série** — Informações completas da série com temporadas, elenco, vídeos e recomendações. |
| <img src="screenshots/temporadas.png" alt="Temporadas" width="300" /> | **Temporadas** — Lista todas as temporadas disponíveis de uma série. |
| <img src="screenshots/episodios.png" alt="Episódios" width="300" /> | **Episódios** — Exibe os episódios de uma temporada com player de vídeo embutido. |
| <img src="screenshots/pessoa.png" alt="Detalhes da Pessoa" width="300" /> | **Detalhes da Pessoa** — Biografia, filmografia, informações pessoais e links sociais de atores e personalidades. |
| <img src="screenshots/keywords.png" alt="Filmes por Palavra-chave" width="300" /> | **Filmes por Palavra-chave** — Página com scroll infinito de filmes filtrados por uma tag/palavra-chave. |
